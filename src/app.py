...
activities = {
    ...
    "Basketball Club": {
        "description": "Skill drills and friendly basketball games",
    ...
    "Math Club": {
        "description": "Solve puzzles, explore math concepts, and compete in contests",
        "schedule": "Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["daniel@mergington.edu", "mia@mergington.edu"]
    }
}
